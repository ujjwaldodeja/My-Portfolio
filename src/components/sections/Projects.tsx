...
const projects = [
  {
    ...
    bullets: [
      ...
      "Improved event-driven architecture for scalable processing and built inference pipelines.",
      "Contributed to design and implementation of enterprise search capabilities.",
      "Enhanced document analysis and PDF processing workflows, improving overall efficiency.",
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "Introduced configurable parameters and modular design for flexibility and scalability.",
      "Significantly reduced inference latency, increased throughput, and eliminated recurring memory and maintenance issues.",
    ],
